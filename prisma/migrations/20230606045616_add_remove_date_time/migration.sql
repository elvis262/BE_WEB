/*
  ...
  - You are about to drop the column `dateTime` on the `consultation` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `consultation` DROP COLUMN `dateTime`;
